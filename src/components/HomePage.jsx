...
//           className=""
//         >
//           <div className='text-indigo-500 font-bold text-5xl mr-10'>
//             {text.map((el, i) => (
//               <motion.span
//                 initial={{ opacity: 0 }}
//                 animate={{ opacity: 1 }}
...
//               className="text-gray-500 font-semibold text-3xl"
//             >
...
//               href="/Nikita Goswami Resume_'24.pdf"
...
//           className=""
//         >
//           <img src="shorthaircoder.gif" alt="" className="h-96 w-auto" />
//         </motion.div>
//       </div>
//     </motion.div>
//   );
